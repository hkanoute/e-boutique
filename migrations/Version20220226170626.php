 ...
 */
final class Version20220226170626 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customer_address ADD user_id INT NOT NULL');
